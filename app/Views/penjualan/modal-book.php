<!-- Modal Add Cart -->
<div class="modal fade" tabindex="-1" id="modal-book" data-bs-backdrop="static" data-bs-keyboard="false">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" onclick="add_to_cart(
                                        ...
                                        '<?= $value['price']; ?>',
                                        '<?= $value['discount']; ?>'
                                    )"><i class="fas fa-plus-circle"></i> Pilih</button>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
...
<div class="modal fade" tabindex="-1" id="modal-update-book">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Update Jumlah Buku</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <input type="hidden" id="rowid" class="mb-3">
                <input type="number" class="form-control" id="qty">
            </div>
            <div class="modal-footer">
                <button onclick="update_to_cart()" type="button" class="btn btn-primary">Simpan</button>
