                ...
                <div class="card-body">
                    ...
                    <form action="/laporan/filter" method="post">
                        <div class="container">
                            <div class="row">
                                <div class="col-4">
                                    <input id="tgl_awal" type="date" class="form-control" name="tgl_awal" value="<?= $tanggal['tgl_awal']; ?>" title="Tanggal Awal">
                                </div>
                                <div class="col-4">
                                    <input id="tgl_akhir" type="date" class="form-control" name="tgl_akhir" value="<?= $tanggal['tgl_akhir']; ?>" title="Tanggal Akhir">
                                </div>
                                <div class="col-4">
                                    <button class="btn btn-secondary">Filter</button>
                                    <a onclick="exportExcel()" class="btn btn-primary">Export Excel</a>
                                    <a target="_blank" onclick="exportPDF()" class="btn btn-warning">Export PDF</a>
                                </div>
                            </div>
                        </div>
                    </form>
                    <!-- Data Laporan -->
                    <table id="datatableSimple" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Sale ID</th>
