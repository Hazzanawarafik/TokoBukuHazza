...
<div id="layoutSidenav_content">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="col-sm-3 mt-3">
                                <input type="number" value="<?= date('Y'); ?>" class="form-control" id="tahun_transaksi" onchange="getTransaksi()">
                            </div>
                        </div>
                        ...
                        <div class="m-3 justify-content-md-end d-md-flex gap-2">
                            ...
                            <button class="btn btn-outline-secondary btn-sm" onclick="downloadChartTransaksi('PDF')">Unduh PDF</button>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <div class="col-sm-3 mt-3">
                                <input type="number" value="<?= date('Y'); ?>" class="form-control" id="tahun_customer" onchange="getCustomer()">
                            </div>
                        </div>
                        ...
                        <div class="m-3 justify-content-md-end d-md-flex gap-2">
                            ...
                            <button class="btn btn-outline-secondary btn-sm" onclick="downloadChartCustomer('PDF')">Unduh PDF</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        //fungsi untuk mengakses data customer
        ...
        function downloadChartCustomer(type) {
            ...
            if (type === "PNG") {
                ...
                //export ke dalam PDF
                convertChartPDF(chart, "chart-transaksi.pdf", "Grafik Jumlah Customer")
            }

        }

        function convertChartImg(download, chart) {
            var img = chart.toDataURL('image/png', 1.0).replace('image/jpg', 'image/octet-stream');
        ...
        function convertChartPDF(chart, filename, title) {
            ...
            doc.addImage(img, 'JPEG', 5, 15, 0, 0)
