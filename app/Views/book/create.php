                        ...
                        <div class=" mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select name="book_category_id" id="" class="form-control">
                                    ...
                                    <<?php foreach ($book_category as $value) : ?> <option value="<?= $value['book_category_id']; ?>" <?= old('book_category_id') == $value['book_category_id'] ? 'selected' : '' ?>><?= $value['name_category']; ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
