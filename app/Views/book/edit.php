                ...
                <div class="card-body">
                    ...
                    <form action="<?= route_to('update-buku', $result['book_id']); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class=" mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select name="book_category_id" id="" class="form-control">
                                    ...
                                    <<?php foreach ($book_category as $value) : ?> <option value="<?= $value['book_category_id']; ?>" <?= old('book_category_id', $result['book_category_id']) == $value['book_category_id'] ? 'selected' : '' ?>><?= $value['name_category']; ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>

                            <label for="book_category_id" class="col-sm-2 col-form-label">Tahun Ternbit</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="release_year" value="<?= old('release_year', $result['release_year']); ?>">
                            </div>
                        </div>
                        <div class=" mb-3 row">
                            <label for="book_category_id" class="col-sm-2 col-form-label">Harga</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="price" value="<?= old('price', $result['price']); ?>">
                            </div>

                            <label for=" book_category_id" class="col-sm-2 col-form-label">Diskon</label>
                            <div class="col-sm-4">
                        ...
                        <div class=" mb-3 row">
                            ...
                            <label for="book_category_id" class="col-sm-2 col-form-label">Stok</label>
                            <div class="col-sm-4">
                        ...
                        <div class=" d-grid gap-2 d-md-block">
                            ...
                            <a class="btn btn-info text-white" href="/book">Kembali</a>
                        </div>
                    </form>
                </div>
                <!--  -->
