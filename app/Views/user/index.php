    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <a href="<?= route_to('create-users'); ?>" class="btn btn-primary mb-3"><i class="fas fa-plus-circle"></i> Tambah Data</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="/reset-password-users/<?= $value['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
                                            <button type="submit" onclick="return confirm('Yakin ingin menghapus data?')" class="btn btn-warning text-white"><i class="fas fa-arrows-rotate"></i> Reset Password</button>
                                        </form>
